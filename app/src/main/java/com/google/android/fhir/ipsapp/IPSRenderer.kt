        ...
        entries?.forEach { entry ->
            when (entry.resource.resourceType) {
                ResourceType.Immunization -> {
                    ...
                    val vaccine = (entry.resource as Immunization).vaccineCode.coding.firstOrNull()?.display ?: ""
                ...
                ResourceType.Patient -> {
                    ...
                    val patientText =
                        "Name: ${patient.name.firstOrNull()?.givenAsSingleString} ${patient.name.firstOrNull()?.family} \nBirth Date: ${patient.birthDateElement.valueAsString}"
                ...
                ResourceType.AllergyIntolerance -> {
                    ...
                    val allergy = allergyEntry.code.coding.firstOrNull()?.display
                    val code = allergyEntry.clinicalStatus.coding.firstOrNull()?.code
                    println(code)
                    if (code == "active" || allergyEntry.code.coding.firstOrNull()?.code == "no-allergy-info") {
